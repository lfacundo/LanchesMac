...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImageUrl,ImageThumbnaiUrl,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImageUrl,ImageThumbnaiUrl,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
